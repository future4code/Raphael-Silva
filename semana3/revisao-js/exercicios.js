...
function retornaNumerosParesElevadosADois(array) {
   ...
   function filmeFavorito() {
      ...
      return `Venha assistir ao filme ${filmeFavoritoAstroDev.nome}, 
   de ${filmeFavoritoAstroDev.ano}, 
   digirido por ${filmeFavoritoAstroDev.diretor}
   e estrelado por ${filmeFavoritoAstroDev.atores[0]},
   ${filmeFavoritoAstroDev.atores[1]}, ${filmeFavoritoAstroDev.atores[2]}, ${filmeFavoritoAstroDev.atores[3]}, ${filmeFavoritoAstroDev.atores[4]}
